            ...
            <div className="ui very relaxed selection list">
              <div className="item">
                ...
                <div className="content">
                  <p className="header">Highway to hell</p>
              ...
              <div className="item">
                <i className="large music middle aligned icon"></i>
                <div className="content">
                  <p className="header">Thunderstruck</p>
                  <div className="description">AC/DC</div>
                </div>
              </div>
              <div className="item">
                <i className="large music middle aligned icon"></i>
                <div className="content">
                  <p className="header">Take me home country roads</p>
              ...
              <div className="active item">
                <i className="large music middle aligned icon"></i>
                <div className="content">
                  <p className="header">It's my life</p>
              ...
              <div className="item">
                <i className="large music middle aligned icon"></i>
                <div className="content">
                  <p className="header">Livin' on a prayer</p>
                  <div className="description">Bon Jovi</div>
                </div>
              </div>
            </div>
